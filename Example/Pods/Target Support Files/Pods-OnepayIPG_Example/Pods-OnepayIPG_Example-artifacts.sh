...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  install_xcframework "${PODS_ROOT}/../../SubDirec/CalendarControl.xcframework" "" "true" "ios-x86_64-maccatalyst/CalendarControl.framework" "ios-arm64/CalendarControl.framework" "ios-arm64_x86_64-simulator/CalendarControl.framework"
fi
