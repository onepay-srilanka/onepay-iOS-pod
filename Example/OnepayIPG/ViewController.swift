...
class ViewController: UIViewController, OnepayIPGDelegate {
    ...
    private func createIPGInit(builder: IPGInitBuilder) -> OnepayIPGInit{
        ...
        builder.setUser(Customer(firstName: "Chamath", lastName: "Rathnayake", phone: "+94778869070", email: "chamathrathnayake95@gmail.com"))
        
        builder.setSecurity(Configurations(token: "3d0cd6ed02ce5e4277e42a6c4c7ff968d2075ed3b3f23a907f31ecbae72e6df9ea23039c0a4da077.B4AA1189E174E887371D7", appID: "KO651189E174E88737186", hashKey: "XGFM1189E174E887371B3"))
        
        builder.setProduct(Product(amount: 1000.58, curency: .LKR, reference: "0000000000060"))
