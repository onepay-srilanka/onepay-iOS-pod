...
class ViewController: UIViewController, OnepayIPGDelegate {
    ...
    private func createIPGInit(builder: IPGInitBuilder) -> OnepayIPGInit{
        ...
        builder.setUser(UserDetails(firstName: "Chamath", lastName: "Rathnayake", phone: "+94778869070", email: "chamathrathnayake95@gmail.com"))
        ...
        builder.setProduct(ProductDetails(amount: 100.05, curency: .LKR, reference: "0000000000060"))
